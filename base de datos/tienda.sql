...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2015 a las 05:13:45
...
INSERT INTO `cliente` (`CEDULA`, `NOMBRE`, `APELLIDO`, `TELEFONO`, `USER`, `PASS`) VALUES
('11', '11', '11', '11', '11', '11'),
('1121930903', 'Emiraldo', 'LOZANO', '6846220', 'emiraldo', '123');
...
INSERT INTO `prestamo` (`IDPRESTAMO`, `FECHA1`, `FECHA2`, `PAGO`, `IDCLIENTE`, `IDJUEGO`) VALUES
(1, '2015-03-11', '2015-03-12', '14500.00', '1121930903', 1);
...
--
ALTER TABLE `prestamo`
MODIFY `IDPRESTAMO` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
